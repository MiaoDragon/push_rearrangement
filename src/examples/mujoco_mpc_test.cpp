...
#include "mujoco_collision_avoidance_nlopt.cpp"
...
{
    // read mujoco scene
    std::string filename = "/home/yinglong/Documents/research/task_motion_planning/non-prehensile-manipulation/mujoco_mpc/mjpc/tasks/robot_push/task.xml";
    ...
    int target_bid = mj_name2id(m, mjOBJ_BODY, "object");
    int jnt_idx = m->body_jntadr[target_bid];
    int qadr = m->jnt_qposadr[jnt_idx];
    ...
    // check the sensor
    int sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "torso_pos");
    std::cout << "torso_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "torso_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;

    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_1_pos");
    std::cout << "left_1_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_1_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;

    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_2_pos");
    std::cout << "left_2_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_2_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_3_pos");
    std::cout << "left_3_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_3_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_4_pos");
    std::cout << "left_4_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_4_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_5_pos");
    std::cout << "left_5_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_5_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_6_pos");
    std::cout << "left_6_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_6_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
    sensor_idx = mj_name2id(m, mjOBJ_SENSOR, "left_7_pos");
    std::cout << "left_7_pos dim: " << m->sensor_dim[sensor_idx] << std::endl;
    std::cout << "left_7_pos data: " << d->sensordata[m->sensor_adr[sensor_idx]] << std::endl;
